...
@connect(
  ({
    loading,
    groupManageAndAccountCenter,
  }: {
    loading: { effects: { [key: string]: boolean } };
    groupManageAndAccountCenter: ModalState;
  }) => ({
    currentUser: groupManageAndAccountCenter.currentUser,
    currentUserLoading: loading.effects['groupManageAndAccountCenter/fetchCurrent'],
  }),
)
class AccountCenter extends PureComponent<AccountCenterProps, AccountCenterState> {
  // static getDerivedStateFromProps(
  //   props: groupManageAndAccountCenterProps,
  //   state: groupManageAndAccountCenterState,
  // ) {
  ...
  componentDidMount() {
    ...
    dispatch({
      type: 'groupManageAndAccountCenter/fetchCurrent',
    });
    dispatch({
      type: 'groupManageAndAccountCenter/fetch',
    });
  }
